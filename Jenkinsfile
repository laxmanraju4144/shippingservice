pipeline {
    ...
    environment {
        IMAGE_NAME = "laxmanraju/shippingservice:${GIT_COMMIT}"
    }
    ...
    stages {
        ...
        stage('Git Checkout') {
            steps {
                git url: 'https://github.com/laxmanraju4144/shippingservice.git', branch: 'main'
            }
        }
            ...
            steps {
                withCredentials([usernamePassword(
                    ...
                    sh '''
                        ...
                        git clone https://$GIT_USERNAME:$GIT_PASSWORD@github.com/laxmanraju4144/GitOps.git 
